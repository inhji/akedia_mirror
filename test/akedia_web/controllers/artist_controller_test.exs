defmodule AkediaWeb.ArtistControllerTest do
  ...
  describe "update artist" do
    ...
    test "redirects when data is valid", %{conn: conn, artist: artist} do
      ...
      assert html_response(conn, 200) =~ "some updated mbid"
    end
