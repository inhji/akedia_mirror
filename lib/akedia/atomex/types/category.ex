defmodule Akedia.Atomex.Types.Category do
  @moduledoc """
  ...
  ## Examples
    ...
    iex> Akedia.Atomex.Types.Category.new("70-s-music")
    {:category, %{term: "70-s-music"}, nil}
    iex> Akedia.Atomex.Types.Category.new("70-s-music", label: "70's music")
