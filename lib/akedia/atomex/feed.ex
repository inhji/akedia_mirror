defmodule Akedia.Atomex.Feed do
  @moduledoc """
  Represent an Atom feed. Embed many `Akedia.Atomex.Entry`
  """

  @type t :: list()

  import XmlBuilder
  alias Akedia.Atomex.Types.{Person, Link, Text, Category}
  ...
  @doc """
  Identify feed generator. Default to Akedia.Atomex with current version.
  ...
  """
  def generator(feed),
    do: add_field(feed, :generator, %{version: Akedia.Atomex.version()}, "Akedia.Atomex")
